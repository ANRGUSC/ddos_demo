    ...
    for nn_model in nn_model_list:
        ...
        for architecture in architecture_list:
            ...
            roc_mean_report_path = (
                input_path + "roc/data/roc_mean_report_" + metric + "_" + mode + ".csv"
            )
            roc_mean_report_path_list.append(roc_mean_report_path)

        output_path = (
            CONFIG.OUTPUT_DIRECTORY
            + "nn_model_analysis/metadata_"
            + metadata_metric
            + "/compare_nn_models/"
            + nn_model
            + "/"
...
def main_plot_correlation_metrics(metric, mode):
    ...
    for nn_model in nn_model_list:
        for architecture in architecture_list:
            ...
            output_path = (
                CONFIG.OUTPUT_DIRECTORY
                + "nn_model_analysis/metadata_comparison/compare_nn_architecture/"
                + architecture
                + "/"
                + nn_model
                + "/"
